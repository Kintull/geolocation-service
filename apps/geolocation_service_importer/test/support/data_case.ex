defmodule GeolocationServiceImporter.DataCase do
  @moduledoc """
  ...
  by setting `use GeolocationServiceImporter.DataCase, async: true`, although
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import GeolocationServiceImporter.DataCase
    end
  end
